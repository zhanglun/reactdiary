...
var EditableBox = React.createClass({displayName: "EditableBox",
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "editbox", onDoubleClick: this.clickToEdit, onKeyPress: this.editDone, ref: "editbox"}, 
                React.createElement("div", {"data-val": this.state.val}, this.state.val), 
                React.createElement("input", {ref: "theInput", type: "text", value: this.state.val, onChange: this.editInputing, onBlur: this.editDone})
